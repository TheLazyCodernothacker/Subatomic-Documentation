  ...
  let ui = (
    <div>
      ...
      <main class="p-4 sm:p-4 md:p-6 lg:p-8 xl:p-10 2xl:p-12">
        ...
        <pre class="sm:p-2 md:p-4 mt-4 lg:mt-6 sm:text-md md:text-lg lg:text-xl xl:text-2xl bg-gray-400 p-4 rounded">
        ...
        <p class="mt-4 lg:mt-6 sm:text-md md:text-lg lg:text-xl xl:text-2xl">
          ...
          tab. You will want to first open page.js (or page.tsx) and edit the
          title and description in the exports.
        </p>
        <pre>
