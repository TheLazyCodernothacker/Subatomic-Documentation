...
export default function Button() {
  ...
  return (
    ...
    class: "mt-4 lg:mt-6 sm:text-md md:text-lg lg:text-xl xl:text-2xl mb-4 lg:mb-6"
  }, "As you can see, Subatomic.js is pretty intuitive and very similar to React. It gets the SEO, SSR, and speed benefits that React doesn't have and makes it a good full-stack framework."), /*#__PURE__*/React.createElement("p", {
    class: "mt-4 lg:mt-6 sm:text-md md:text-lg lg:text-xl xl:text-2xl"
