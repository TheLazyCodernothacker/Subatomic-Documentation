...
function render(build, data) {
  ...
  }, "Subatomic.js is a minimalistic JS framework with Pre-rendering and SSR for creating dynamic web apps."), /*#__PURE__*/React.createElement("button", {
  ...
  }, "Subatomic.js uses Pre-rendering to make sure your dynamic content is indexed by search bots and SSR to make data fetching and rendering faster. You also get to have interactivity without sacrificing SEO or performance."), /*#__PURE__*/React.createElement("h1", {
    class: "text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl mt-4 sm:mt-6 md:mt-8 lg:mt-10 xl:mt-12 font-semibold"
...
const page = {
  ...
  description: "Subatomic.js is a minimalistic JS framework with Pre-rendering and SSR for creating dyanmic web apps.",
